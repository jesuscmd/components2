...
function mediaBreakpointBetween(
...
export const DarkDesertTheme: Theme = {
  // tema oscuro
...
export const DarkTheme: any = { // tema oscuro
  name: "Dark", // nombre tema oscuro

  white: "#fff",
  gray100: '#fafafa',  // white
  gray200: '#e0e0e0',  // grayLight
  gray300: '#9d9d9d',  // basicColors.light
  gray400: '#929292',  // gray
  gray500: '#777777',  // basicColors.main
  gray600: '#515151',  // basicColors.dark
  gray700: '#4c4c4c',  // grayDark
  gray800: '#262626',  // darkLight
  gray900: '#1a1a1a',  // dark
  black: "#000",
  ...
  linkColor:  "#0085b8",
  bodyEmphasisColor: "#FFF",

};

export const LightTheme: any = { // tema oscuro
  name: "Light", // nombre tema claro
  ...
  linkColor:  "#0085b8",
  bodyEmphasisColor: "#000",
};

export const BaseTheme: any = { // tema oscuro
  ...
  fontSizeRoot: "16px",
  fontSizeBase: "1.5rem", 
  fontFamilySansSerif: 'Montserrat, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"',
